        ...
        <div class="container-fluid">
            ...
            <div class="row pt-2 pb-2">
                <div class="col-sm-9">
                    ...
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active" aria-current="page">Điều Chỉnh Câu Hỏi</li>
                    </ol>
                </div>
            ...
            <form action="{{url('/question')}}" method="POST" enctype="multipart/form-data">
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="card">
                            <div class="card-header text-uppercase">Dữ Liệu Câu Hỏi</div>
                            <div class="card-body">

                                <label>Mô Tả</label>
                                <textarea id="summernoteEditor" name="description">{{$question['description']}}
                                </textarea>
                                <hr>
